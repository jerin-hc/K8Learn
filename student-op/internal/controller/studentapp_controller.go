...
// +kubebuilder:rbac:groups=student-app.ij3rry,resources=studentapps,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=student-app.ij3rry,resources=studentapps/status,verbs=get;update;patch
// +kubebuilder:rbac:groups=student-app.ij3rry,resources=studentapps/finalizers,verbs=update
